...
(function (df) {
     ...
     * 资源地址
     * */
    df.RESOURCE_URL = "http://xm.android.uc2018.foxuc.net/static/minigame/resource/";
    /**
     * df  常量定义
     */
    ...
    df.LEN_EXTERNUID = 33; //外联标识
    df.LEN_WXCODE = 33; //微信代码
    df.LEN_SIGNATURE = 64; //数字签名 
    df.LEN_INITVECTOR = 33; //初始向量      
    //数据长度
    df.LEN_QQ = 16; //Q Q 号码
    ...
    df.MatchVersion = "";
    /**广场版本 */
    df.PLAZA_VERSION = utils.PROCESS_VERSION(8, 2, 0, 1);
    /**登录行为 */
    df.BEHAVIOR_LOGON_IMMEDIATELY = 0x1000;
    /**
     * 特殊日志
     */
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    //授权地址
    df.AUTHOR_WEB = 'http://www.foxuc.com/WXMp/H5QrCodeLogon.aspx?RawUrl=http://h5demo.foxuc.com/index.html';
    df.AUTHOR_PHONE = 'http://phone.foxuc.com/WXMp/H5WxLogon.aspx?RawUrl=http://h5demo.foxuc.com/index.html';
    //公告
    df.NOTIFY_URL = "http://service.foxuc.com/GameNotice.aspx?StationID=" + ("" + df.STATION_ID) + "&TypeID=1&KindID=0";
    //常见问题
    df.QUESTION_URL = "http://service.foxuc.com/GameNotice.aspx?StationID=" + ("" + df.STATION_ID) + "&TypeID=2&KindID=1";
    //比赛规则
    df.MATCHRULE_URL = "http://service.foxuc.com/GameMatch.aspx?PlazaStation=" + ("" + df.STATION_ID) + "&TypeID=1&MatchID=";
    /**
     * 系统时间
     */
    ...
    df.MODE_BATTLE_SCORE = 22; //约战成绩
    //缓存键值
    df.LocalStorageKey = {
        LOGONACCESS: "LogonAccess",
        WXAUTHOR: "WXAuthor",
        LASTLOGIN: "LastLogin",
        LOGONINFO: "LogonInfo",
        WXHEADURL: "WXHeadURL",
